document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- STATS COUNTER (Only runs on the homepage) ---
    ...
    // --- FORM SUBMISSION & "THANK YOU" POP-UP (for ALL forms) ---
    ...
    allForms.forEach(form => {
        form.addEventListener('submit', function (event) {
            ...
            // Check if this is the enrollment form to generate a code
            ...
            if (submissionIdInput) {
                ...
                // 2. Put the code into the hidden input field
            ...
            fetch(form.action, {
                ...
                if (response.ok) {
                    if (thankYouPopup) {
                        // 3. Update the pop-up message based on which form was submitted
                        ...
                        if (submissionID) {
                            ...
                            // This message will show for the "Send us a Message" contact form
